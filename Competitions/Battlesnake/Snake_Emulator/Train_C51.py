...
if conv_layer_params is not None:
    board_preprocessing = Sequential([
        ...
        keras.layers.Conv2D(conv_layer_params[0][0], conv_layer_params[0][1], conv_layer_params[0][2], activation='relu'),
        keras.layers.Conv2D(conv_layer_params[1][0], conv_layer_params[1][1], conv_layer_params[1][2], activation='relu'),
...
dataset = replay_buffer.as_dataset(
    ...
    num_steps=int(dataset_num_steps+n_step_update-1),
